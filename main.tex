...
\begin{equation}
\begin{tikzcd}
\cdots \arrow[r, "\partial_A" description] & A_{d+1} \arrow[r, "\partial_A" description] \arrow[d, "f_{d+1}" description] & A_d \arrow[r, "\partial_A" description] \arrow[d, "f_d" description] & A_{d-1} \arrow[r, "\partial_A" description] \arrow[d, "f_{d-1}" description] & \cdots \\
\cdots \arrow[r, "\partial_B" description] & B_{d+1} \arrow[r, "\partial_B" description]                                  & B_d \arrow[r, "\partial_B" description]                              & B_{d-1} \arrow[r, "\partial_B" description]                                  & \cdots
\end{tikzcd}
\end{equation}
...
\begin{equation}
\begin{tikzcd}
\cdots \arrow[r, "\partial" description] & C_{d+1}(X) \arrow[r, "\partial" description] \arrow[d, "f_{d+1}" description] & C_d(X) \arrow[r, "\partial" description] \arrow[d, "f_d" description] & C_{d-1}(X) \arrow[r, "\partial" description] \arrow[d, "f_{d-1}" description] & \cdots \\
\cdots \arrow[r, "\partial" description] & C_{d+1}(Y) \arrow[r, "\partial" description]                                  & C_d(Y) \arrow[r, "\partial" description]                              & C_{d-1}(Y) \arrow[r, "\partial" description]                                  & \cdots
\end{tikzcd}
\end{equation}
...
\begin{equation}
\begin{tikzcd}
0 \arrow[r] & C_d(A) \arrow[r, "i", hook] \arrow[d, "\partial" description] & C_d(X) \arrow[r, "j", two heads] \arrow[d, "\partial" description] & {C_d(X,A)} \arrow[r] \arrow[d, "\partial" description] & 0 \\
...
\cdots \arrow[r] & A_{d+1} \arrow[r, "\partial"] \arrow[d, "i" description, hook]      & A_d \arrow[r, "\partial"] \arrow[d, "i" description, hook]      & A_{n-1} \arrow[r, "\partial"] \arrow[d, "i" description, hook]      & \cdots \\
\cdots \arrow[r] & B_{d+1} \arrow[r, "\partial"] \arrow[d, "j" description, two heads] & B_d \arrow[r, "\partial"] \arrow[d, "j" description, two heads] & B_{d-1} \arrow[r, "\partial"] \arrow[d, "j" description, two heads] & \cdots \\
...
\begin{equation}
\begin{tikzcd}
A \arrow[r, "i"] \arrow[d, "\alpha" description] & B \arrow[r, "j"] \arrow[d, "\beta" description] & C \arrow[r, "k"] \arrow[d, "\gamma" description] & D \arrow[r, "l"] \arrow[d, "\delta" description] & E \arrow[d, "\epsilon" description] \\
